...
function getAllNames(array) {
  const getAllNames = array.forEach((item) => console.log(item.name));
  return getAllNames;
}
...
function getUserById(array, id) {
  const getUserById = array.forEach((item) => {
    if (item.id === id) {
      console.log(item);
    }
  });
...
function removeAddresses(array) {
  const removeAddresses = array.map((item) => delete item.address);
  console.log(array);
}
...
function deleteUser(array, id) {
  const deleteUser = array.filter((item) => item.id !== id);
  return deleteUser;
}
...
function getUsersGeo(array, id) {
  const getUsersGeo = array.find((item) => item.id === id);
  return getUsersGeo.address.geo;
}
...
function getUsersCompany(array, id) {
  const getUsersCompany = array.find((item) => item.id === id);
  return getUsersCompany.company;
}

console.log(getUsersCompany(users, 10));
...
console.log(changePhone(users, 10, "899889"));
